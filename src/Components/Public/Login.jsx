                    ...
                    <div className="relative px-4 py-10 bg-white border border-zinc-100 shadow-lg md:rounded-3xl rounded-2xl md:p-20">
                        ...
                        <div className="py-8 text-base space-y-6 text-gray-700">
                            <div className="relative">
                                ...
                                <label htmlFor="email" className="text-gray-400 peer-focus:text-gray-600 absolute left-0 -top-5 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-5 peer-focus:text-sm">Email Address</label>
                            </div>
                            <div className="relative">
                                {errors.password && (
                                    <span className="absolute right-0 -top-5 text-xs text-right text-rose-600">
                                ...
                                <label htmlFor="password" className="text-gray-400 peer-focus:text-gray-600 absolute left-0 -top-5 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-5 peer-focus:text-sm">Password</label>
                            </div>
